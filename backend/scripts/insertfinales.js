...
//
$(function() {
	//if user not have the permission then go to login
	if (!isLoggedIn()) document.location="login.html";
	//else show the page
	MacthList();
	$(document).on('click', '.resultat', function(){ 

		school1 = $(this).attr("data-ecole1");
		school2 = $(this).attr("data-ecole2");
